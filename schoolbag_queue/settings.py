...
ROOT_URLCONF = 'schoolbag_queue.urls'
...
WSGI_APPLICATION = 'schoolbag_queue.wsgi.application'
...
DATABASE_ROUTERS = ['schoolbag_queue.routers.SchoolbagDBRouter',]
# Password validation
